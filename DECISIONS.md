...
- [Bounded per-cell piece-tile fetch concurrency and bake retries](#2026-08-03-backend-realtime-bounded-per-cell-piece-tile-fetch-concurrency-and-bake-retries) -> verified against the real ~99.5%-locked synthetic-1m prod board: 462 of 464 real straggler cells fixed (10 zero-composite, 452 of 454 incomplete-composite); 2 cells still blocked on two specific broken piece-tile AVIF objects on R2 (persistent 503 on GET, unrelated to this code), not yet re-uploaded.
