...
- [Board bounded by a build-time play zone, camera and pieces clamped to it](#2026-05-21-frontend-canvas-play-zone-hard-limits) -> Phase 2 needs server-side position validation and revisits the bound under viewport sharding.
