...
- [Server-computed minimap grid](#2026-06-06-backend-realtime-server-computed-minimap-grid), [per-tile piece cap](#2026-06-11-backend-realtime-per-tile-piece-cap-on-non-merging-drops), [hot-tile residency](#2026-06-05-frontend-canvas-hot-tile-residency-frees-covered-cold-clusters), [stale-hold sweep](#2026-07-05-backend-realtime-grab-reservation-race-and-stale-hold-sweep), [paced region_state batching](#2026-07-06-backend-realtime-paced-region_state-batching) -> five unmeasured defaults (24h resync interval, 8x tile-cap multiplier, resident-piece budget/hot TTL, `MPP_STALE_HOLD_MS`, batch size/poll interval). All held clean through synthetic soak and lock testing up to real board scale, but none have seen real concurrent public play yet; sanity-check once the event has run a while.
