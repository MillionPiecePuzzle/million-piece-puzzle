...
Revisit when: `docker-run-mosaic.sh` or an equivalent becomes a real committed script if this stops being an occasional manual step; the WSL2 memory bump is a one-time machine setting, not per-run.
