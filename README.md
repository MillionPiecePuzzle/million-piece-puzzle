...
Feature-complete. All roadmap phases (local MVP, closed alpha, public 1M, open access, launch readiness) are closed. Production serves the 1,000,000-piece `earth-mosaic` board ahead of the public event.
