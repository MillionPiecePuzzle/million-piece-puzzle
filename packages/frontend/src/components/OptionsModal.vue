...
const KOFI_URL = "https://ko-fi.com/krantt";
    ...
    >
      ...
      >
        ...
        <div class="actions">
          ...
          <a class="action kofi" :href="KOFI_URL" target="_blank" rel="noopener">
            <svg class="kofi-mark" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
              <path
                fill="currentColor"
