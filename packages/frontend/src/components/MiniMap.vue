...
function draw(): void {
  ...
  // closes hairline seams between neighbours. Loose and locked scale against
  // their own independent maxima (not a shared one): loose pieces vastly
  // outnumber locked ones for most of the puzzle's life, so a shared max would
  // dilute a handful of locked pieces to near-invisible alpha.
