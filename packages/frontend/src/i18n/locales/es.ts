...
const es: MessageSchema = {
  ...
  bookmarks: {
    ...
    add: "Guardar esta vista",
    full: "Tu cuaderno está lleno con {max} marcadores. Elimina uno para añadir otro.",
    badgeSource: "Origen de la miniatura",
    sourcePieces: "Piezas de aquí",
    sourcePhoto: "Foto",
    pickBadge:
      "Haz clic en la foto de referencia para elegir la miniatura que representa este rincón y luego ponle nombre.",
    pickPiece:
      "Elige una pieza de esta vista como miniatura que representa este rincón y luego ponle nombre.",
    usePiece: "Usar esta pieza como miniatura",
