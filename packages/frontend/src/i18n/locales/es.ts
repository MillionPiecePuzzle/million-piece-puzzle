...
const es: MessageSchema = {
  ...
  updates: {
    ...
    v140: {
      ...
      share:
        "Envía un marcador a alguien: cópialo desde su fila, y pegarlo en su propio cuaderno lo lleva exactamente a ese punto con el mismo marcador para guardarlo.",
      multiCarry:
        "Con una pieza en mano, haz Ctrl-clic en otras piezas para llevar hasta 10 a la vez y luego doble clic en el tablero para dejarlas todas una al lado de otra.",
  ...
  bookmarks: {
    ...
    import: "Pegar un marcador",
    importTitle: "Pegar un marcador",
    importLede: "Pega el marcador que te han enviado y guárdalo en tu cuaderno.",
    importLabel: "Marcador compartido",
    importPlaceholder: "pégalo aquí",
    importAction: "Abrir",
    importBad: "Eso no es un marcador compartido. Copia la línea entera que te enviaron.",
    full: "Tu cuaderno está lleno con {max} marcadores. Elimina uno para añadir otro.",
    aimPlace: "Colocar en el tablero",
    aimMove: "Mover el punto",
    aimClick: "Pulsa el tablero",
    ...
    copy: "Copiar {name} para enviarlo",
    copied: "Marcador copiado",
    copyFailed: "Tu navegador no ha permitido copiar el marcador.",
    ...
    tagAdd: "Añadir esta etiqueta",
    tagDrop: "Quitar la etiqueta {name}",
    ...
    hintRename: "Cambiar el nombre",
    hintTags: "Etiquetas",
    hintCopy: "Copiar para enviar",
    hintDelete: "Eliminar",
    prev: "ant.",
    next: "sig.",
    fileExport: "Exportar el cuaderno",
    fileImport: "Importar un cuaderno",
    fileAdded: "{n} marcador añadido. | {n} marcadores añadidos.",
    fileNothingNew: "Tu cuaderno ya tiene todos los marcadores de ese archivo.",
    fileBad: "Ese archivo no es un cuaderno de marcadores.",
    fileOtherBoard: "Ese cuaderno se escribió para otro tablero.",
    fileTooBig: "Ese archivo es demasiado grande para ser un cuaderno.",
  },
  flags: {
