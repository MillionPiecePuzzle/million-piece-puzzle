...
const es: MessageSchema = {
  ...
  bookmarks: {
    ...
    importLede: "Pega el enlace de marcador que te han enviado y guarda el rincón que señala.",
    ...
    pickSpot:
      "Haz clic en el tablero donde quieres el marcador. El cuadrado bajo el cursor será su miniatura.",
    pickPiece: "Pulsa una pieza del tablero. Esa pieza representará el rincón.",
    nameSpot: "Ponle nombre a este rincón.",
    sharedTitle: "Un rincón que te han enviado",
    sharedLede: "Guarda este rincón en tu cuaderno, con este nombre o con el tuyo.",
    badgeKind: "Miniatura",
    badgeKindArea: "Un cuadrado",
    badgeKindPiece: "Una pieza",
    badgeSize: "Tamaño",
    badgeSizePieces: "{n} pieza | {n} piezas",
    nothingHere: "Este cuadrado queda fuera de la imagen. Apunta dentro del tablero.",
    noPieceHere: "Aquí no hay ninguna pieza. Pulsa una que el tablero dibuje, o toma un cuadrado.",
    nameLabel: "Nombre del marcador",
    namePlaceholder: "nombra este rincón",
