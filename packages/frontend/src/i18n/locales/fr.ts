...
const fr: MessageSchema = {
  ...
  bookmarks: {
    ...
    badgeSource: "Source de la vignette",
    sourcePieces: "Pièces ici",
    sourcePhoto: "Photo",
    pickBadge:
      "Cliquez sur la photo de référence pour choisir la vignette qui représente ce coin, puis nommez-le.",
    pickPiece:
      "Choisissez une pièce de cette vue comme vignette qui représente ce coin, puis nommez-le.",
    usePiece: "Utiliser cette pièce comme vignette",
