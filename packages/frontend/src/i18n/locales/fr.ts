...
const fr: MessageSchema = {
  ...
  updates: {
    ...
    v140: {
      ...
      share:
        "Envoyez un signet à quelqu'un : copiez-le depuis sa ligne, et le coller dans son propre carnet l'emmène exactement à cet endroit avec le même signet à garder.",
      multiCarry:
        "Avec une pièce en main, Ctrl-cliquez d'autres pièces pour en porter jusqu'à 10 d'un coup, puis double-cliquez sur le plateau pour toutes les poser côte à côte.",
  ...
  bookmarks: {
    ...
    import: "Coller un signet",
    importTitle: "Coller un signet",
    importLede: "Collez le signet qu'on vous a envoyé, et gardez-le dans votre carnet.",
    importLabel: "Signet partagé",
    importPlaceholder: "collez-le ici",
    importAction: "Ouvrir",
    importBad: "Ce n'est pas un signet partagé. Copiez toute la ligne qu'on vous a envoyée.",
    full: "Votre carnet est plein à {max} signets. Supprimez-en un pour en ajouter un autre.",
    aimPlace: "Placer sur le plateau",
    aimMove: "Déplacer le point",
    aimClick: "Cliquez sur le plateau",
    ...
    copy: "Copier {name} pour l'envoyer",
    copied: "Signet copié",
    copyFailed: "Votre navigateur n'a pas autorisé la copie du signet.",
    ...
    tagAdd: "Ajouter ce tag",
    tagDrop: "Retirer le tag {name}",
    ...
    hintRename: "Renommer",
    hintTags: "Tags",
    hintCopy: "Copier pour l'envoyer",
    hintDelete: "Supprimer",
    prev: "préc.",
    next: "suiv.",
    fileExport: "Exporter le carnet",
    fileImport: "Importer un carnet",
    fileAdded: "{n} signet ajouté. | {n} signets ajoutés.",
    fileNothingNew: "Votre carnet contient déjà tous les signets de ce fichier.",
    fileBad: "Ce fichier n'est pas un carnet de signets.",
    fileOtherBoard: "Ce carnet a été écrit pour un autre plateau.",
    fileTooBig: "Ce fichier est trop gros pour être un carnet.",
  },
  flags: {
