...
const fr: MessageSchema = {
  ...
  bookmarks: {
    ...
    importLede: "Collez le lien de signet qu'on vous a envoyé, et gardez le coin qu'il désigne.",
    ...
    pickSpot:
      "Cliquez sur le plateau à l'endroit du signet. Le carré sous le curseur devient sa vignette.",
    pickPiece: "Cliquez une pièce sur le plateau. Cette pièce représentera le coin.",
    nameSpot: "Nommez ce coin.",
    sharedTitle: "Un coin qu'on vous a envoyé",
    sharedLede: "Gardez ce coin dans votre carnet, sous ce nom ou sous le vôtre.",
    badgeKind: "Vignette",
    badgeKindArea: "Un carré",
    badgeKindPiece: "Une pièce",
    badgeSize: "Taille",
    badgeSizePieces: "{n} pièce | {n} pièces",
    nothingHere: "Ce carré est hors de l'image. Visez dans le plateau.",
    noPieceHere: "Aucune pièce ici. Cliquez-en une que le plateau affiche, ou prenez un carré.",
    nameLabel: "Nom du signet",
    namePlaceholder: "nommez ce coin",
