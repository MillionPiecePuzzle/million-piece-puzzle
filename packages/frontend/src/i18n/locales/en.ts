const en = {
  ...
  bookmarks: {
    ...
    importLede: "Paste a bookmark link someone sent you, and keep the spot it points at.",
    ...
    pickSpot:
      "Click the board where you want the bookmark. The square under your cursor becomes its badge.",
    pickPiece: "Click a piece on the board. That piece stands for the spot.",
    nameSpot: "Name this spot.",
    sharedTitle: "A spot someone sent you",
    sharedLede: "Keep this spot in your notebook, under this name or one of your own.",
    badgeKind: "Badge",
    badgeKindArea: "A square",
    badgeKindPiece: "A piece",
    badgeSize: "Size",
    badgeSizePieces: "{n} piece | {n} pieces",
    nothingHere: "This square is off the picture. Aim inside the board.",
    noPieceHere: "No piece here. Click one the board is drawing, or badge a square instead.",
