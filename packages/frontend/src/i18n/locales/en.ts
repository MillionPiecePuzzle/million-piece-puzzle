const en = {
  ...
  bookmarks: {
    ...
    add: "Bookmark a spot",
    import: "Paste a link",
    importTitle: "Paste a bookmark link",
    importLede: "Paste a bookmark link someone sent you, and keep it in your notebook.",
    importLabel: "Bookmark link",
    importPlaceholder: "paste the link here",
    importAction: "Open it",
    importBad: "That link carries no bookmark. Copy the whole line you were sent.",
    full: "Your notebook is full at {max} bookmarks. Delete one to add another.",
    pickSpot:
      "Click the board where you want the bookmark. The area of the picture under your cursor becomes its badge.",
    pickPiece: "Click a piece on the board. That piece stands for the bookmark.",
    nameSpot: "Name this bookmark.",
    sharedTitle: "A bookmark someone sent you",
    sharedLede: "Keep this bookmark in your notebook, under this name or one of your own.",
    badgeKind: "Badge",
    badgeKindArea: "An area",
    badgeKindPiece: "A piece",
    badgeSize: "Size",
    badgeSizePieces: "{n} piece | {n} pieces",
    badgeSizeWheel: "Scroll over the board to resize the square.",
    nothingHere: "There is no picture here. Aim inside the image.",
    noPieceHere: "No piece here. Click one the board is drawing, or badge an area instead.",
    nameLabel: "Bookmark name",
    namePlaceholder: "name this bookmark",
    ...
    tagsDraftLede: "Pick the tags for this bookmark.",
    tagsPick: "Choose tags",
    tagsNoneYet: "none yet",
    tagsNone: "No tags yet. Type a word and create it.",
    tagNoMatch: "No tag matches that.",
    tagPlaceholder: "find or create a tag",
    tagNew: "Tag name",
    tagCreate: "Create",
    tagNeedName: "Name the tag before creating it.",
    tagWorn: "This bookmark already has that tag.",
    tagsFull: "A bookmark carries {max} tags. Remove one to add another.",
    tagsOf: "Tags for {name}",
    backToList: "Back to the list",
    backToEntry: "Back to the bookmark",
    hintFavorite: "Add to favorites",
    hintUnfavorite: "Remove from favorites",
    hintTags: "Tags",
    hintCopyLink: "Copy a link",
    hintDelete: "Delete",
    prev: "prev",
    next: "next",
  },
