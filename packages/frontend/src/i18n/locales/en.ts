const en = {
  ...
  updates: {
    ...
    v140: {
      ...
      share:
        "Send a bookmark to someone: copy it from its row, and pasting it into their own notebook takes them to that exact spot with the same bookmark to keep.",
      multiCarry:
        "With a piece in hand, Ctrl-click other pieces to carry up to 10 at once, then double-click the board to lay them all down side by side.",
  ...
  bookmarks: {
    ...
    add: "Bookmark a spot",
    import: "Paste a bookmark",
    importTitle: "Paste a bookmark",
    importLede: "Paste the bookmark someone sent you, and keep it in your notebook.",
    importLabel: "Shared bookmark",
    importPlaceholder: "paste it here",
    importAction: "Open it",
    importBad: "That is not a shared bookmark. Copy the whole line you were sent.",
    ...
    copy: "Copy {name} to send it",
    copied: "Bookmark copied",
    copyFailed: "Your browser would not let the bookmark be copied.",
    delete: "Delete {name}",
    tag: "Tag",
    tags: "Tags",
    tagAll: "All",
    ...
    hintRename: "Rename",
    hintTags: "Tags",
    hintCopy: "Copy to send",
    hintDelete: "Delete",
    prev: "prev",
    next: "next",
    fileExport: "Export the notebook",
    fileImport: "Import a notebook",
    fileAdded: "{n} bookmark added. | {n} bookmarks added.",
    fileNothingNew: "Your notebook already holds every bookmark in that file.",
    fileBad: "That file is not a bookmark notebook.",
    fileOtherBoard: "That notebook was written for another board.",
    fileTooBig: "That file is too large to be a notebook.",
  },
  flags: {
    bar: "Personal flags",
