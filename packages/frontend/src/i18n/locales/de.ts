...
const de: MessageSchema = {
  ...
  bookmarks: {
    ...
    add: "Diese Ansicht merken",
    full: "Dein Notizbuch ist mit {max} Lesezeichen voll. Lösche eines, um ein neues anzulegen.",
    badgeSource: "Quelle des Bildchens",
    sourcePieces: "Teile hier",
    sourcePhoto: "Foto",
    pickBadge:
      "Klicke auf das Referenzfoto, um das Bildchen für diese Stelle zu wählen, und benenne sie dann.",
    pickPiece:
      "Wähle ein Teil aus dieser Ansicht als Bildchen für diese Stelle, und benenne sie dann.",
    usePiece: "Dieses Teil als Bildchen verwenden",
