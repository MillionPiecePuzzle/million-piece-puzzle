...
const de: MessageSchema = {
  ...
  bookmarks: {
    ...
    importLede:
      "Füge den Lesezeichen-Link ein, den dir jemand geschickt hat, und behalte die Stelle, auf die er zeigt.",
    ...
    pickSpot:
      "Klicke auf dem Spielfeld an die Stelle des Lesezeichens. Das Quadrat unter dem Zeiger wird sein Bildchen.",
    pickPiece: "Klicke ein Teil auf dem Spielfeld an. Dieses Teil steht dann für die Stelle.",
    nameSpot: "Benenne diese Stelle.",
    sharedTitle: "Eine Stelle, die dir jemand geschickt hat",
    sharedLede: "Behalte diese Stelle in deinem Notizbuch, unter diesem Namen oder deinem eigenen.",
    badgeKind: "Bildchen",
    badgeKindArea: "Ein Quadrat",
    badgeKindPiece: "Ein Teil",
    badgeSize: "Größe",
    badgeSizePieces: "{n} Teil | {n} Teile",
    nothingHere: "Dieses Quadrat liegt außerhalb des Bildes. Ziele ins Spielfeld.",
    noPieceHere:
      "Hier ist kein Teil. Klicke eines an, das das Spielfeld zeigt, oder nimm ein Quadrat.",
    nameLabel: "Name des Lesezeichens",
    namePlaceholder: "diese Stelle benennen",
