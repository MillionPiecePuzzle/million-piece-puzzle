...
const de: MessageSchema = {
  ...
  updates: {
    ...
    v140: {
      ...
      share:
        "Schick jemandem ein Lesezeichen: Kopiere es aus seiner Zeile, und wer es in sein eigenes Notizbuch einfügt, landet genau an dieser Stelle und bekommt das gleiche Lesezeichen zum Behalten.",
      multiCarry:
        "Mit einem Teil in der Hand kannst du weitere Teile mit Strg-Klick aufnehmen, bis zu 10 auf einmal, und sie dann per Doppelklick aufs Board alle nebeneinander ablegen.",
  ...
  bookmarks: {
    ...
    import: "Lesezeichen einfügen",
    importTitle: "Lesezeichen einfügen",
    importLede:
      "Füge das Lesezeichen ein, das dir jemand geschickt hat, und behalte es in deinem Notizbuch.",
    importLabel: "Geteiltes Lesezeichen",
    importPlaceholder: "hier einfügen",
    importAction: "Öffnen",
    importBad: "Das ist kein geteiltes Lesezeichen. Kopiere die ganze Zeile, die du bekommen hast.",
    ...
    copy: "{name} zum Verschicken kopieren",
    copied: "Lesezeichen kopiert",
    copyFailed: "Dein Browser hat das Kopieren des Lesezeichens nicht zugelassen.",
    delete: "{name} löschen",
    tag: "Tag",
    tags: "Tags",
    tagAll: "Alle",
    tagUntagged: "Ohne Tag",
    viewPick: "Nach Tag filtern",
    viewDrop: "Nicht mehr nach {name} filtern",
    viewEmpty: "Hier ist kein Lesezeichen.",
    tagsNoneYet: "noch keine",
    tagPlaceholder: "Tag hinzufügen",
    tagAdd: "Diesen Tag hinzufügen",
    tagDrop: "Tag {name} entfernen",
    ...
    hintTags: "Tags",
    hintCopy: "Zum Verschicken kopieren",
    hintDelete: "Löschen",
    prev: "zurück",
    next: "weiter",
    fileExport: "Notizbuch exportieren",
    fileImport: "Notizbuch importieren",
    fileAdded: "{n} Lesezeichen hinzugefügt. | {n} Lesezeichen hinzugefügt.",
    fileNothingNew: "Dein Notizbuch enthält bereits jedes Lesezeichen aus dieser Datei.",
    fileBad: "Diese Datei ist kein Lesezeichen-Notizbuch.",
    fileOtherBoard: "Dieses Notizbuch wurde für ein anderes Board geschrieben.",
    fileTooBig: "Diese Datei ist zu groß für ein Notizbuch.",
  },
  flags: {
