...
// What the HUD actually renders: a stored choice where the player made one, the
// viewport's own default everywhere else. Both the rails and the options menu
// read this, so a switch always shows the state the board is in.
