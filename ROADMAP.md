...
### `qa-and-load`
- [x] Unit tests for the merge-and-anchor path (`handleDrop`/`applyMerge`) and the serial dispatch queue; load test of 20 concurrent clients dragging a 10 000-piece puzzle without saturation
